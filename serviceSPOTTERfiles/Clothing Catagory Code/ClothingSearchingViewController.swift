//
//  ReligionSearchingViewController.swift
//  VolunteerAPP
//
...
import UIKit
import SwiftUI
class ClothingSearchingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let childView = UIHostingController(rootView: ClothingSearchView())
        addChild(childView)
