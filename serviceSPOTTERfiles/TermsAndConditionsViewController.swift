...
//  homelessAID
//
//  Created by Arushi Sharmaa on 8/18/21.
//
...
class TermsAndConditionsViewController: UIViewController {
    @IBOutlet weak var webView: WKWebView!
        ...
        override func viewDidLoad() {
            super.viewDidLoad()
            webView.load(URLRequest(url: URL(string: "https://servicespotteraustin.github.io/TermsandConditions/")!))
        ...
        @IBAction func didTapButtonSeeServices(_ sender: Any) {
            let pvc = storyboard?.instantiateViewController(identifier: "p-vc") as! PrefViewController
            present(pvc, animated: true)
        }
        @IBAction func didTapButtonSeeMap(_ sender: Any) {
