...
//  homelessAID
//
//  Created by Arushi Sharmaa on 8/8/21.
//
...
class AboutUsViewController: UIViewController {
    ...
    @IBAction func didPressEmail(_ sender: UIButton) {
        UIApplication.shared.open(URL(string:"mailto:servicespotteraustin@gmail.com/channel/UCaxFwsrlJbvS1iB20Db56IQ")! as URL, options: [:], completionHandler: nil)
    }
    var menuOut = false
