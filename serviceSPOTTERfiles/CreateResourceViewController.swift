//
//  CreatResourceViewController.swift
//  homelessAID
//
...
import WebKit
class CreateResourceViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        webView.load(URLRequest(url: URL(string: "https://forms.gle/DyqhjfcmvRbRkiub9")!))
