//
//  HealthCareSearchingViewController.swift
//  homelessAID
//
...
import UIKit
import SwiftUI
class HealthCareSearchingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let childView = UIHostingController(rootView: HealthCareSearchView())
        addChild(childView)
